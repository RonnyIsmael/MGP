...
@section('content')
    <div class="row mt-4">
        ...
        <div class="col-12 text-center">
            ...
            <button id="botonGenerar" type="submit" class="btn btn-dark btn mb-2">Generar</button>
            <button id="botonDescargarServidor" type="submit" class="btn btn-dark btn mb-2">Descargar Servidor</button>
            <p>
    ...
    <script type="text/javascript">
        ...
        var botonDescargarServidor = document.getElementById('botonDescargarServidor');
        botonDescargarServidor.addEventListener('click', function () {
            window.open('https://launcher.mojang.com/v1/objects/d0d0fe2b1dc6ab4c65554cb734270872b72dadd6/server.jar');
        });
        ...
        botonGenerar.addEventListener('click', function () {
            ...
            var out = '#Minecraft server properties version: ' + versionName + '\n' +
                'spawn-protection=16\n' +
                'max-tick-time=60000\n' +
                'query.port=25565\n' +
                'generator-settings=\n' +
